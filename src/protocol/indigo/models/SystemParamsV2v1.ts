...
export interface SystemParamsV2v1 {
...
export function getCdpCreatorAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getCdpAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getCollectorAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getExecuteAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getGovernanceAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getPollManagerAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getPollShardAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getStabilityPoolAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getStakingAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getTreasuryAddress(systemParams: SystemParamsV2v1, networkId: string): string {
...
export function getVersionRegistryAddress(systemParams: SystemParamsV2v1, networkId: string): string {

...
import { assetClassToString, toStakingPosition, toStakingPositionV1 } from '../../helpers';
 ...
 */
export class StakingPositionIndexer extends BaseV1Indexer {
    /*
        ...
        if (
            ...
            for (const key in tx.outputs) {
                ...
                if (
                    ...
                    const stakingPosition = toStakingPositionV1(
                        output.datum
                    );
                    const stakedAmount =

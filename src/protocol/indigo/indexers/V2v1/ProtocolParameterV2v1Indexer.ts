...
import { getGovernanceAddress } from '../../models/SystemParamsV2v1';
 ...
 */
export class ProtocolParameterV2v1Indexer extends BaseV2v1Indexer {
    /*
        ...
        for (const key in tx.outputs) {
            ...
            if (
                ...
                await this.database.insertProtocolParameterHistory({
                    ...
                    treasury_indy_withdrawn_amt: govDatum[5],
                    version: 'v2.1'
                });
            }
        }

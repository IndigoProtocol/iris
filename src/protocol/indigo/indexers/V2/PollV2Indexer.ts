...
import { getPollManagerAddress, getPollShardAddress } from '../../models/SystemParamsV2';
 ...
 */
export class PollV2Indexer extends BaseV2Indexer {
    /*
        ...
        switch (proposalContent.tag) {
            case 121:
                return stringify({
                    ...
                    redemption_ratio_percentage: proposalContent.value[2].value[0],
                    maintenace_ratio_percentage: proposalContent.value[3].value[0],
                    liquidation_ratio_percentage: proposalContent.value[4].value[0],
                    debt_minting_fee_percentage: proposalContent.value[5].value[0],
                    liquidation_processing_fee_percentage: proposalContent.value[6].value[0],
                    stability_pool_withdrawal_fee_percentage: proposalContent.value[7].value[0],
                    redemption_reimbursement_percentage: proposalContent.value[8].value[0],
                    redemption_processing_fee_percentage: proposalContent.value[9].value[0],
                    interest_rate_percent: proposalContent.value[10].tag === 121 ? proposalContent.value[10].value[0].value[0] : null,
                });
            case 122:
                return stringify({
                    assetName: proposalContent.value[0].toString('hex'),

...
const defaultLogger: Logger = createLogger(loggerConfig(ApplicationContext.Indexer));
...
function logInfo(message: string, context: ApplicationContext = ApplicationContext.Indexer): Logger {
    switch (context) {
...
function logError(message: string, context: ApplicationContext = ApplicationContext.Indexer): Logger {
    switch (context) {
        case ApplicationContext.Indexer:

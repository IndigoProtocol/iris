...
export class LiquidityPoolResource extends BaseEntityResource {
  ...
  toJson(entity: LiquidityPool): Object {
    return {
      ...
      state: entity.latestState
        ? this._stateResource.toJson(entity.latestState)
        : null,
  ...
  toCompressed(entity: LiquidityPool): Object {
    return {
      ...
      tA: entity.tokenA
        ? this._assetResource.toCompressed(entity.tokenA)
        : null,
      tB: entity.tokenB
        ? this._assetResource.toCompressed(entity.tokenB)
        : null,
      cS: entity.createdSlot,
      s: entity.latestState
        ? this._stateResource.toCompressed(entity.latestState)
        : null,

...
export class LiquidityPoolSwapResource extends BaseEntityResource {
  ...
  toJson(entity: LiquidityPoolSwap): Object {
    const response: any = {
      swapInToken: entity.swapInToken
        ? this._assetResource.toJson(entity.swapInToken)
        : null,
      swapOutToken: entity.swapOutToken
        ? this._assetResource.toJson(entity.swapOutToken)
        : null,
  ...
  toCompressed(entity: LiquidityPoolSwap): Object {
    const response: any = {
      t: 'LiquidityPoolSwap',
      siT: entity.swapInToken
        ? this._assetResource.toCompressed(entity.swapInToken)
        : null,
      soT: entity.swapOutToken
        ? this._assetResource.toCompressed(entity.swapOutToken)
        : null,
      oT: entity.type,

...
export class OperationStatusResource extends BaseEntityResource {
    ...
    if (entity.operationEntity) {
      switch (entity.operationEntity.constructor) {
        case LiquidityPoolSwap:
          response.operationEntity = new LiquidityPoolSwapResource().toJson(
            entity.operationEntity as LiquidityPoolSwap
          );
          break;
        case LiquidityPoolDeposit:
          response.operationEntity = new LiquidityPoolDepositResource().toJson(
            entity.operationEntity as LiquidityPoolDeposit
          );
          break;
        case LiquidityPoolWithdraw:
          response.operationEntity = new LiquidityPoolWithdrawResource().toJson(
            entity.operationEntity as LiquidityPoolWithdraw
          );
          break;
        // todo include zaps
      }
  ...
  toCompressed(entity: OperationStatus): Object {
    ...
    if (entity.operationEntity) {
      switch (entity.operationEntity.constructor) {
        case LiquidityPoolSwap:
          response.oE = new LiquidityPoolSwapResource().toCompressed(
            entity.operationEntity as LiquidityPoolSwap
          );
          break;
        case LiquidityPoolDeposit:
          response.oE = new LiquidityPoolDepositResource().toCompressed(
            entity.operationEntity as LiquidityPoolDeposit
          );
          break;
        case LiquidityPoolWithdraw:
          response.oE = new LiquidityPoolWithdrawResource().toCompressed(
            entity.operationEntity as LiquidityPoolWithdraw
          );
          break;
      }

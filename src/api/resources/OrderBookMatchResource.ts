...
export class OrderBookMatchResource extends BaseEntityResource {
    ...
    toJson(entity: OrderBookMatch): Object {
        let response: any = {
            referenceOrder: this._orderBookOrderResource.toJson(entity.referenceOrder),
            fromToken: entity.matchedToken ? this._assetResource.toJson(entity.matchedToken) : null,
    ...
    toCompressed(entity: OrderBookMatch): Object {
        let response: any = {
            ...
            fT: entity.matchedToken ? this._assetResource.toCompressed(entity.matchedToken) : null,

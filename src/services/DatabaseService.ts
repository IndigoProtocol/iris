...
export class DatabaseService extends BaseService {
  ...
  public boot(
    ...
    const databaseConnector: string | undefined =
      this.databaseConnectorFromType(CONFIG.DATABASE_TYPE);
    ...
    this.dbSource = new DataSource({
      ...
      entities: ['dist/**/entities/*.js', ...entities],
      migrations: ['dist/**/migrations/*.js', ...migrations],
  ...
  public async transaction(
    logicFunc: (manager: EntityManager) => any,
    retryOnDuplicate: boolean = false,
    isolationLevel: IsolationLevel = 'READ UNCOMMITTED'
  ): Promise<any> {

  ...
  protected compressEntity(entity: BaseEntity): Object {
    try {
      switch (entity.constructor) {
        ...
        case LiquidityPool:
          return new LiquidityPoolResource().toCompressed(
            entity as LiquidityPool
          );
        case LiquidityPoolState:
          return new LiquidityPoolStateResource().toCompressed(
            entity as LiquidityPoolState
          );
        case LiquidityPoolSwap:
          return new LiquidityPoolSwapResource().toCompressed(
            entity as LiquidityPoolSwap
          );
        case LiquidityPoolDeposit:
          return new LiquidityPoolDepositResource().toCompressed(
            entity as LiquidityPoolDeposit
          );
        case LiquidityPoolWithdraw:
          return new LiquidityPoolWithdrawResource().toCompressed(
            entity as LiquidityPoolWithdraw
          );
        case OperationStatus:
          return new OperationStatusResource().toCompressed(
            entity as OperationStatus
          );
        case LiquidityPoolTick:
          return new LiquidityPoolTickResource().toCompressed(
            entity as LiquidityPoolTick
          );
        case OrderBook:
          return new OrderBookResource().toCompressed(entity as OrderBook);
        case OrderBookOrder:
          return new OrderBookOrderResource().toCompressed(
            entity as OrderBookOrder
          );
        case OrderBookMatch:
          return new OrderBookMatchResource().toCompressed(
            entity as OrderBookMatch
          );
        case OrderBookTick:
          return new OrderBookTickResource().toCompressed(
            entity as OrderBookTick
          );
        default:
          return {};
      }
